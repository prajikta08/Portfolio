...
const About = () => {
  ...
  return (
    <>
      ...
      <Particles className="fixed inset-0 -z-10 pointer-events-none" />
      ...
      <section id="about" className='c-space section-spacing relative'>
        ...
        <div className='grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12'>
          ...
          <div className='flex items-end grid-default-color grid-1'>
            ...
            />
            <div className='z-10'>
              <p className='headtext'>Hi, I'm Prajikta Sati</p>
              <p className='subtext'>
                Over the past year in college, I have strengthened my frontend and backend 
                skills to create dynamic, fully functional web applications.
              </p>
            </div>
          ...
          <div className='grid-special-color grid-4'>
            <div className='flex flex-col items-center justify-center gap-4 size-full'>
              <p className='text-center headtext'>Want to team up or collaborate on something together?</p>
              <EmailButton />
            </div>
          </div>
